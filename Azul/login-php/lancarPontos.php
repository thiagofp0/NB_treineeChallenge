...
*{
	...
	padding:0;
	color:black;
	font-family:'Mario Kart Regular';
	}
		...
		<section id="main">
			<div class="inner">
				...
				<section id="one" class="wrapper style1">
					...
					<div class="content">
						<form>
							<p>Nome:</p><input type="text" name="novaAtividade"><br>
							<p>Atividade:</p><select>
								<option>Captacao Ativa</option>
								<option>Site</option>
								<option>Candidatar a Diretor</option>
								<option>Ser voce</option>
								<option>Trabalhar</option>
							</select><br>
							<input type="reset" name="adicionarAtividade" value="Adicionar">
						</form>
					</div>
				</section>
